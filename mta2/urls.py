...
urlpatterns = [
    ...
    url(r"^review/", include(("peer_review.urls", "peer_review"), namespace="review")),
    url(
        r"^assignment/",
        include(("peer_assignment.urls", "peer_assignment"), namespace="assignment"),
    ),
    url(r"^grade/", include(("peer_grade.urls", "peer_grade"), namespace="grade")),
    url(
        r"^calibration/",
        include(("peer_calibration.urls", "peer_calibration"), namespace="calibration"),
    ),
    url(
        r"^evaluation/",
        include(("peer_evaluation.urls", "peer_evaluation"), namespace="evaluation"),
    ),
