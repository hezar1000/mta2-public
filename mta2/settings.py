"""
Django settings for mta2 project.
...
# REDIS_URL = "redis://:kv4C94WSNDI1RAjHsTEqola263I4q3NB@redis-17026.c8.us-east-1-4.ec2.cloud.redislabs.com:17026/0"
...
WSGI_APPLICATION = "mta2.wsgi.application"
SITE_ID = 1
...
LOGGING = {
    ...
    "handlers": {
        "default_log": {
            ...
            "filename": os.path.join(BASE_DIR, "mta2", "logs", "django.log"),
            "formatter": "base",
        },
        "events_log": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": os.path.join(BASE_DIR, "mta2", "logs", "events.log"),
            "formatter": "base",
        },
        "debug_log": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": os.path.join(BASE_DIR, "mta2", "logs", "debug.log"),
            "formatter": "base",
        },
        "requests_log": {
            "level": "INFO",
            "class": "logging.FileHandler",
            "filename": os.path.join(BASE_DIR, "mta2", "logs", "requests.log"),
            "formatter": "base",
        },
    },
    "loggers": {
